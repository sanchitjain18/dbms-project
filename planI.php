    ...
    <div class="dropdown-content">
      ...
      <div class="row">
        <div class="column">
          ...
          <a href="Recharge.php">1.4GB data/day, Unlimited Calls (Local+STD+National Roaming) and 100 Local+STD SMS/day <b>28 DAYS</b><br><b> Rs. 199</b></a>
          <a href="Recharge.php">2GB data/day, Unlimited Calls (Local+STD+National Roaming) and 100 Local+STD SMS/day <b>70 DAYS</b><br><b> Rs. 398</b></a>    
        </div>
        <div class="column">
        ...
        <div class="column">
          <h3>Internet</h3>
            <a href="Recharge.php">3GB data. <b>1 DAY</b><br><b> Rs. 53</b></a>
        </div>
          <div class="column">
          <h3>Talktime</h3>
